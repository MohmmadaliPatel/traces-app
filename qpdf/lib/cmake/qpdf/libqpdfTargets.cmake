...
foreach(_cmake_expected_target IN ITEMS qpdf::libqpdf qpdf::libqpdf_static)
...
set_target_properties(qpdf::libqpdf_static PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "z;jpeg;ssl;crypto;msvcrt;ws2_32;shell32;advapi32;gdi32;user32;crypt32"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/libqpdfTargets-*.cmake")
